      ...
      <div className={styles.teamSection}>
        ...
        <div className={styles.teamInfo}>
          ...
          <p>
            ...
            that help students manage the pressures of academic life, fostering
            self-awareness and emotional resilience. Through our supportive
            communities, students can connect, learn, and grow in a safe,
            nurturing space. Our team includes mental health professionals, tech
            innovators, and student advocates, all working together to empower
